...
<div class="relative -mx-4 -mt-2">
	<svg class="w-full" version="1.1" viewBox="0 0 264.58 39.688" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="absolute top-[0.35rem] w-full text-center font-cheap-pine text-3xl tracking-widest">
		{title}
	</div>
</div>
