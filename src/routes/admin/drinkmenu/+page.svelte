...
<div class="flex flex-col items-center gap-16">
	...
	<div
		class="grid h-[220mm] max-h-[220mm] w-[331mm] grid-cols-3 items-stretch gap-[6mm] bg-white py-[8mm] pl-[17mm] pr-[23mm] shadow-2xl"
		id="drinkmenu"
		bind:this={downloadables[0]}
	>
		<div class="p-2">
			<div class="flex h-full flex-col border-2 border-dashed border-gray-900 p-3">
				...
				>
					...
					<div>
						Alpi Klostergarten-Limonaden (Apfel-Rosmarin / Birne-Ingwer /
						Apfel-Johannisbeer-Lavendel)
					</div>
				</div>
	...
	<div class="text-center">
		...
		<br />
		Datenformat: 331x220mm, Beschnitt: 5mm, Sicherheitsabstand: 3mm
	</div>
</div>
