...
<div class="relative">
	<svg version="1.1" viewBox="0 0 264.58 39.688" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="absolute top-4 w-full text-center font-cheap-pine text-6xl tracking-widest">
		{title}
	</div>
</div>
