...
>
	<div class="filter drop-shadow-xl">
		...
		<h1
			class="text-center font-display font-semibold text-6xl md:text-8xl 2xl:text-9xl text-gray-200 pt-2 mb-32"
		>
			Josua
		</h1>
	</div>
	<button on:click={scrollDown} class="absolute bottom-12 text-gray-200">
		<svg
